...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT o.id as id, o.checkIn as checkIn, o.checkOut as checkOut, o.client.id as userId," +
            "o.state as state, o.hotel.id as hotelId, o.hotel.name as hotelName, o.totalAmount as totalAmount FROM Order o WHERE o.client.id =?1")
    List<OrderProjection> getAllOrderProjectionByUserId(long id );

    @Query("SELECT o.id as id, o.checkIn as checkIn, o.checkOut as checkOut, o.client.id as userId," +
            "o.state as state, o.hotel.id as hotelId, o.hotel.name as hotelName, o.totalAmount as totalAmount FROM Order o WHERE o.hotel.id =?1 AND o.state =?2")
    List<OrderProjection> getAllOrderProjectionByHotelIdAndState(long id, State state);

    @Query("SELECT o.id as id, o.checkIn as checkIn, o.checkOut as checkOut, o.hotel.id as hotelId, o.hotel.name as hotelName, o.totalAmount as totalAmount" +
