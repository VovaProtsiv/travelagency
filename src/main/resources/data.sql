...
insert into orders (id, check_in, check_out, client_id, state) values (1000, '2021-08-16','2021-08-17',1000, 'NEW');
insert into orders (id, check_in, check_out, client_id, state) values (1001, '2021-08-19','2021-08-22',1000,'NEW');
insert into orders (id, check_in, check_out, client_id, state) values (1002, '2021-08-16','2021-09-28',1002,'DONE');
insert into orders (id, check_in, check_out, client_id, state) values (1003, '2021-09-01','2021-09-02',1002,'CANCELED');
